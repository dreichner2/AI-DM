...
def test_socket_rate_keys_keep_player_messages_separate_but_share_admin_attempts():
    ...
    assert admin_passcode_rate_key('workspace-1', '127.0.0.1') == 'admin-passcode:workspace-1:127.0.0.1'
    assert admin_passcode_rate_key('workspace-1', None) == 'admin-passcode:workspace-1:unknown'
