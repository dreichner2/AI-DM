...
API_TYPE_CONTRACTS: tuple[TypeContract, ...] = (
    ...
    TypeContract('CoherenceFeedbackResponse', alias='{ feedback_id: number; feedback: TurnFeedbackReport }'),
    TypeContract(
        'BetaIncidentsResponse',
        alias='{ incidents: JsonRecord[]; summary: { failed_turn_count: number; failed_canon_job_count: number; bad_turn_report_count: number; telemetry_incident_count: number }; limit: number; session_id?: number }',
    ),
    TypeContract(
        'BetaAuditsResponse',
        alias='{ state_mutations: JsonRecord[]; operator_actions: JsonRecord[]; summary: { state_mutation_count: number; operator_action_count: number }; limit: number; session_id?: number }',
    ),
    TypeContract(
        'BetaSessionQualityResponse',
        alias='{ session: JsonRecord; summary: JsonRecord; operator_summary: JsonRecord; provider_model_turn_counts: JsonRecord[]; recent_state_mutations: JsonRecord[]; recent_operator_actions: JsonRecord[]; limit: number }',
    ),
    TypeContract(
        'BetaSupportBundleResponse',
        alias='{ generated_at: string | null; workspace_id: string; filters: JsonRecord; runtime: JsonRecord; session: JsonRecord | null; beta_summary: JsonRecord; beta_slo: JsonRecord; session_quality: BetaSessionQualityResponse | null; incidents: BetaIncidentsResponse; audits: BetaAuditsResponse; recent_turns: JsonRecord[]; canon_jobs: JsonRecord[]; session_log_entries: JsonRecord[]; turn_events: JsonRecord[]; telemetry: JsonRecord }',
    ),
    TypeContract(
        'World',
        fields=(
    ...
    TypeContract(
        ...
        fields=(
            field('exportedAt', 'string'),
            field('selectedIds', '{ campaignId: number; sessionId: number; playerId: number | null }'),
            field('campaign', 'Campaign'),
            field('selectedSession', 'SessionSummary'),
            field('players', 'PlayerDetail[]'),
            field('selectedPlayer', 'PlayerDetail | null'),
            field('sessionState', 'SessionState'),
            field('logEntries', 'SessionLogEntry[]'),
            field('turnEvents', 'TurnEventPayload[]'),
    ...
    TypeContract('SessionRecapSource', alias="'state_snapshot' | 'session_state' | 'recent_turns' | 'empty'"),
    TypeContract(
        'SessionRecapState',
        fields=(
            field('rolling_summary', 'string'),
            field('current_location', 'string'),
            field('current_quest', 'string'),
            field('updated_at', 'string | null'),
        ),
    ),
    TypeContract(
        ...
        fields=(
            ...
            field('recap', 'string'),
            field('source', 'SessionRecapSource'),
            field('generated', 'boolean'),
            field('state', 'SessionRecapState'),
        ),
    ),
    TypeContract(
    ...
    TypeContract(
        ...
        fields=(
            field('activeCheckpointId', 'string | null'),
            field('completedCheckpointIds', 'string[]'),
            field('skippedCheckpointIds', 'string[]'),
            field('failedCheckpointIds', 'string[]'),
            field('statusByCheckpointId', 'Record<string, string>'),
            field('progressRevision', 'number'),
        ),
    ),
    TypeContract(
    ...
    TypeContract(
        ...
        fields=(
            field('startCheckpointId', 'string | null'),
            field('nodes', 'CampaignPackCommentaryGraphNode[]'),
            field('nodeIds', 'string[]'),
            field('edges', 'CampaignPackCommentaryGraphEdge[]'),
    ...
    TypeContract(
        ...
        fields=(
            field('id', 'string'),
            field('checkpointId', 'string'),
            field('title', 'string'),
            field('summary', 'string'),
            field('status', 'string', optional=True),
            field('reason', 'string | null', optional=True),
            field('edgeType', 'string', optional=True),
            field('fromCheckpointId', 'string', optional=True),
            field('fromTitle', 'string', optional=True),
        ),
    ),
    TypeContract(
        ...
        fields=(
            ...
            field('checkpointIds', 'string[]'),
        ),
    ),
    TypeContract(
        'CampaignPackCommentarySummary',
        fields=(
            field('routeTakenCount', 'number'),
            field('roadsNotTakenCount', 'number'),
            field('alternateEndingsCount', 'number'),
            field('undiscoveredRecordsCount', 'number'),
        ),
    ),
    TypeContract(
        ...
        fields=(
            ...
            field('sessionId', 'number'),
            field('campaignId', 'number'),
            field('pack', 'CampaignPackCommentaryPack'),
            field('progress', 'CampaignPackCommentaryProgress'),
            field('graph', 'CampaignPackCommentaryGraph'),
            field('routeTaken', 'CampaignPackCommentaryCheckpoint[]'),
            field('roadsNotTaken', 'CampaignPackCommentaryCheckpoint[]'),
            field('alternateEndings', 'CampaignPackCommentaryCheckpoint[]'),
            field('undiscoveredRecords', 'Record<string, CampaignPackCommentaryRecord[]>'),
            field('summary', 'CampaignPackCommentarySummary'),
            field('commentary', 'string[]'),
        ),
    ),
    TypeContract('ContentRating', alias="'standard' | 'mature' | 'unrestricted'"),
    TypeContract(
        'SessionContentSettings',
        fields=(
            field('content_rating', 'ContentRating'),
            field('contentRating', 'ContentRating'),
            field('tone_tags', 'string[]'),
            field('toneTags', 'string[]'),
            field('updated_at', 'string | null'),
            field('updatedAt', 'string | null'),
            field('ratings', 'ContentRating[]'),
            field('available_tone_tags', 'string[]'),
            field('availableToneTags', 'string[]'),
        ),
    ),
    TypeContract(
        ...
        fields=(
            field('session_id', 'number'),
            field('settings', 'SessionContentSettings'),
        ),
    ),
    TypeContract(
    ...
    TypeContract(
        'PlayNowExamplePack',
        fields=(
            field('example_pack_id', 'string'),
            field('pack_id', 'string'),
            field('source_filename', 'string | null'),
            field('source', 'string'),
        ),
    ),
    TypeContract(
    ...
    TypeContract(
        ...
        fields=(
            ...
            field('player_id', 'number'),
            field('world_id', 'number'),
            field('socket', "{ event: 'join_session'; payload: PlayNowJoinSessionPayload }"),
            field('send_message', "{ event: 'send_message'; payload: PlayNowSendMessagePayload }"),
        ),
    ),
    TypeContract(
        'PlayNowResponse',
        fields=(
            ...
            field('player_id', 'number'),
            field('world_id', 'number'),
            field('idempotent_replay', 'boolean'),
            field('campaign', 'Campaign'),
            field('session', 'SessionSummary'),
            field('player', 'PlayerDetail'),
