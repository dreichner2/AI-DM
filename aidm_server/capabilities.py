...
HTTP_ENDPOINT_CAPABILITIES: dict[tuple[str, str], Capability] = {
    ...
    ('campaigns.get_campaign_canon', 'GET'): 'player_read',
    ...
    ('segments.list_segments', 'GET'): 'player_read',
    ('segments.get_segment', 'GET'): 'player_read',
    ...
    ('creatures.get_campaign_bestiary', 'GET'): 'player_read',
    ('creatures.get_region_bestiary', 'GET'): 'player_read',
